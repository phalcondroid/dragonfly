...
import 'package:dragonfly_builder/builder.dart' as _i3;
...
final _builders = <_i1.BuilderApplication>[
  ...
  _i1.apply(
    r'dragonfly_builder:repository_generator',
    [_i3.repositoryGenerator],
    _i1.toDependentsOf(r'dragonfly_builder'),
    hideOutput: false,
    appliesBuilders: const [r'source_gen:combining_builder'],
  ),
  _i1.apply(
    r'dragonfly_builder:injectable_builder',
    [_i3.injectableBuilder],
    _i1.toDependentsOf(r'dragonfly_builder'),
    hideOutput: true,
  ),
  _i1.apply(
    r'dragonfly_builder:injectable_config_builder',
    [_i3.injectableConfigBuilder],
    _i1.toRoot(),
    hideOutput: false,
  ),
  _i1.apply(
    r'dragonfly_builder:factory_model_generator',
    [_i3.factoryModelGenerator],
    _i1.toDependentsOf(r'dragonfly_builder'),
    hideOutput: false,
    appliesBuilders: const [r'source_gen:combining_builder'],
  ),
